...
print('dectect error num is %d, detect error rate is %s' % (detect_error, detect_error_rate))
print('indentify error num is %d, indentify error rate is %s' % (identify_error, identify_error_rate))
