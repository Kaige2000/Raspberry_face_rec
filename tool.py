...
#
#         # # 对比已有图像，是否重复,测试用
#         # KaigeZhu_image = face_recognition.load_image_file(
#         #     "C:\\Users\\Kaige\\OneDrive\\学习\\毕业设计\\FaceDetect\\known\\me.jpg")
#         # KaigeZhu_face_encoding = face_recognition.face_encodings(KaigeZhu_image)[0]
#         # known_face_encodings = [
#         #     KaigeZhu_face_encoding,
#         # ]
#         # results = face_recognition.compare_faces(known_face_encodings, face_recognition.face_encodings(new_img_np)[0])
#         # if True in results:
#         #     print('重复')
#         #     return 123
#         #
